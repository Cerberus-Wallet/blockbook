...
sudo systemctl stop blockbook-vanar-vanguard
sudo systemctl disable blockbook-vanar-vanguard
sudo rm /etc/systemd/system/blockbook-vanar-vanguard.service 
sudo systemctl daemon-reload
sudo apt purge blockbook-vanar-vanguard -y
